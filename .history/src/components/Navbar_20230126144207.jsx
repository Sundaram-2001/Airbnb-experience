...
function Navbar(){
    ...
    return(
        ...
        <nav>
            ...
            <button  title="Available Languages"  className='button--globe'><img  className='button--image' src="../images/world-wide-web(1).png" alt="" /></button>
            <button title="More" onClick={globeClick} class="button--menu"><i class="fa fa-bars"></i> </button>
        </nav>
